...
description: The preface to my PhD thesis — on AI, how research is changing, and the kind of researcher I want to become.
...
*Adapted from the preface of my PhD thesis, September 2026. Chapter references refer to the thesis.*

<figure class="post-woodcut">
  <img src="{{ '/assets/img/danse-macabre.svg' | relative_url }}" alt="Four skeletons dancing in a fifteenth-century woodcut." width="705" height="599">
  <figcaption><em>Danse macabre</em>, woodcut by Michael Wolgemut from Hartmann Schedel's <em>Nuremberg Chronicle</em> (1493).</figcaption>
</figure>
